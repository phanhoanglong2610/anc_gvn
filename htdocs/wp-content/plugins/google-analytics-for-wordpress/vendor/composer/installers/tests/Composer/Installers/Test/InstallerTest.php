...
class InstallerTest extends TestCase
{
    ...
    public function dataForTestInstallPath()
    {
        return array(
            ...
            array('elgg-plugin', 'mod/sample_plugin/', 'gvn/sample_plugin'),
            ...
            array('lithium-library', 'libraries/li3_gvn/', 'user/li3_test'),
            array('magento-library', 'lib/foo/', 'gvn/foo'),
            ...
            array('phpbb-extension', 'ext/gvn/foo/', 'gvn/foo'),
            array('phpbb-style', 'styles/foo/', 'gvn/foo'),
            array('phpbb-language', 'language/foo/', 'gvn/foo'),
            array('pimcore-plugin', 'plugins/MyPlugin/', 'ubikz/my_plugin'),
            array('ppi-module', 'modules/foo/', 'gvn/foo'),
            array('puppet-module', 'modules/puppet-name/', 'puppet/puppet-name'),
            array('redaxo-addon', 'redaxo/include/addons/my_plugin/', 'shama/my_plugin'),
            array('redaxo-bestyle-plugin', 'redaxo/include/addons/be_style/plugins/my_plugin/', 'shama/my_plugin'),
            array('roundcube-plugin', 'plugins/base/', 'gvn/base'),
            array('roundcube-plugin', 'plugins/replace_dash/', 'gvn/replace-dash'),
            ...
            array('zend-extra', 'extras/library/zend_gvn/', 'shama/zend_test'),
