...
* Display posts from multiple categories or types. (e.g. Newest, Most viewed, related, specific posts etc.).
...
* Multisite supported.
* Show the standard post contents or select which content you want to display. (Title, image, Excerpt, text from post area, read more text, Category name etc.)
* Option to enable CSS3 / hardware acceleration for transitions.  
