...
?>
				<div>
					<div id="<?php ThemeHelper::getFormName('font_h1_size_'.$index.'_slider'); ?>"></div>
					<input type="text" name="<?php ThemeHelper::getFormName('font_h1_size_'.$index); ?>" id="<?php ThemeHelper::getFormName('font_h1_size_'.$index); ?>" class="to-slider-range" readonly/>
				...
				<script type="text/javascript">
					...
					{
						var element=$('.to').themeOptionElement();
						element.createSlider('#<?php ThemeHelper::getFormName('font_h1_size_'.$index.'_slider'); ?>',1,100,<?php echo (int)$this->data['option']['font_h1_size_'.$index]; ?>);
					});
				</script>				
<?php
			}
...
?>
			...
			<li>
				...
				<div>
					<input type="text" name="<?php ThemeHelper::getFormName('font_h1_line_height'); ?>" id="<?php ThemeHelper::getFormName('font_h1_line_height'); ?>" value="<?php echo ThemeHelper::esc_attr($this->data['option']['font_h1_line_height']); ?>" maxlength="255"/>
				</div>
			</li>
		</ul>
